...
const Pagination = ({ page, totalPages, onPagination }: Props) => {
    ...
    return (
        <div className="mt-3">
            <div className="flex gap-3">
                <button
                    className={
                        'w-9 h-9 flex items-center justify-center rounded-md border border-slate-300'
                        + (isFirst ? ' bg-slate-300 text-white' : ' cursor-pointer hover:bg-cyan-500 hover:text-white')
                    }
                ...
                <button
                    className={
                        'w-9 h-9 flex items-center justify-center rounded-md border border-slate-300'
                        + (isLast ? ' bg-slate-300 text-white' : ' cursor-pointer hover:bg-cyan-500 hover:text-white')
                    }
                    onClick={nextPage}
                    disabled={isLast}
                >
            ...
            <p className="text-center">{page}/{totalPages}</p>
        </div>
    )
}
